    ...
    (formData.promoter_ids || []).forEach((sfx) => {
      if (sfx)
        docFields.push({
          id: `photo${sfx}`,
          field: `photo${sfx}`,
          label: `Partner Photo (${sfx.replace("_", "")})`,
        });
    });
  ...
  return (
    <div className="main-container">
      ...
      <aside
        ...
        style={{
          width: isSidebarCollapsed ? 15 : 248,
          flexShrink: 0,
          position: "relative",
        ...
        {isSidebarCollapsed ? (
          <button
            ...
            style={{
              ...
              borderLeft: "none",
              boxShadow: "2px 0 8px rgba(27,79,216,0.15)",
              cursor: "pointer",
              display: "flex",
              alignItems: "center",
          ...
          >
            {/* Dynamic Collapse Button (Tighter) */}
            <button
            ...
            >
              ...
              >
                <svg
                  ...
                  strokeWidth="2.5"
                >
                  <path d="M4 19.5A2.5 2.5 0 016.5 17H20M4 19.5A2.5 2.5 0 006.5 22H20a2 2 0 002-2V5a2 2 0 00-2-2H6.5A2.5 2.5 0 004 5.5v14z" />
                </svg>
                Pages
              </button>
              <button
            ...
            <div style={{ padding: "8px 18px 12px", background: "#F8FAFC" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                />
                <span
                  style={{ fontSize: 10.5, color: "#64748B", fontWeight: 600 }}
                >
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                <div
                  style={{ fontSize: 13, fontWeight: 800, color: "#1E293B" }}
                >
                  {selectedDoc.label}
                </div>
                <div
                  style={{ fontSize: 10, color: "#1B4FD8", fontWeight: 700 }}
                >
                  Workspace Tools
                </div>
              </div>
            ...
            >
              ...
              <button
                onClick={() => {
                  ...
                  link.download = `GST_Doc_${selectedDoc.label.replace(
                    /\s/g,
                    "_"
                  )}.png`;
                  link.click();
          ...
          >
            ...
            >
              ...
              >
                <span style={{ fontSize: 14 }}>💡</span> <b>Scroll</b> to Zoom |{" "}
                <b>Click & Drag</b> to Pan (Left/Right/All)
              </p>
              <button
                onClick={() => {
                  setZoom(1);
