...
export default function Tab3_AuthSignatory({
  data,
  update,
  errors,
  touched,
  ...
  return (
    <>
      {data["Also Authorized Signatory"] && (
        <InfoAlert type="info">
          <strong>Note:</strong> These details have been automatically filled
          from the Promoter section because you selected "Also Authorized
          Signatory" there. Any changes you make here will be saved for the
          signatory specifically.
        </InfoAlert>
      )}
      ...
      <SectionCard title="Identity Information" icon="🪪">
        ...
        <FormToggle
          label="Are you a citizen/resident of India?"
          value={!!data.toggle_3}
          onChange={(v) => update("toggle_3", v)}
        />
        <Grid2>
          <FormInput
            label="Passport Number (Foreigners only)"
            {...f("as_passport")}
      ...
      <SectionCard title="Residential Address" icon="🏠">
        <InfoAlert>
          i. Address validations are mandatory in the GST system.
          <br />
      ...
      <SectionCard title="Documents" icon="📎">
        <FormSelect
          label="Proof of details of authorized signatory"
        ...
        />
        <FileInput
          label="Upload Photograph (JPEG only, max 100KB)"
          value={data.as_photo}
