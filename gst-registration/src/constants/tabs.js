...
export const INITIAL_STATE = {
  ...
  district: null,
  "Reason to obtain registration": null,
  name_first: "",
  name_middle: "",
  name_last: "",
  father_first: "",
  ...
  landmark_res_2: "",
  photo_2: null,
  "Also Authorized Signatory_2": false,
  is_primary: false,
  as_name_first: "",
  as_name_middle: "",
  as_name_last: "",
  ...
  apb_warehouse: false,
  apb_wholesale: false,
  apb_works_contract: false,
  apb_others: false,
  apb_others_specify: null,
  hsn_search: "",
  commodities_list: [],
  sac_search: "",
  services_list: [],
  nature_of_possession_ppb: "",
  electricity_board: "",
  consumer_number: "",
  prof_tax_ec: "",
  prof_tax_rc: "",
