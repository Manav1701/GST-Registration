      ...
      <header style={{ background:"#fff", borderBottom:"1px solid #E2E8F0", boxShadow:"0 1px 5px rgba(15,23,42,0.06)", position:"sticky", top:0, zIndex:50 }}>
        <div style={{ maxWidth:1400, margin:"0 auto", padding:"0 24px", height:62, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ width:36, height:36, background:"linear-gradient(135deg,#1B4FD8,#3B82F6)", borderRadius:9, display:"flex", alignItems:"center", justifyContent:"center" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:14 }}>
            {contactInfo.mobile && (
              <div style={{ display:"flex", alignItems:"center", gap:8, background:"#EEF4FF", border:"1px solid #C7D9FF", borderRadius:8, padding:"6px 12px" }}>
