...
export const FormInput = ({
  ...
  <FieldWrapper label={label} required={required} error={error} hint={hint}>
    <input
      ...
      style={inputBase(error, disabled || readOnly)}
      onFocus={(e) => {
        if (!disabled && !readOnly) {
          e.target.style.borderColor = "#1B4FD8";
          e.target.style.boxShadow = "0 0 0 3px rgba(27,79,216,0.12)";
        }
      }}
      onBlurCapture={(e) => {
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          height: 22,
          borderRadius: 11,
          background: value ? "#1B4FD8" : "#CBD5E1",
          border: "none",
          cursor: "pointer",
        ...
        >
          <div
            style={{
              ...
              borderRadius: "50%",
              border: `2px solid ${
                value === item.value ? "#1B4FD8" : "#CBD5E1"
              }`,
              background: value === item.value ? "#1B4FD8" : "#fff",
              display: "flex",
              alignItems: "center",
    ...
    >
      <div
        ...
        style={{
          ...
          flexShrink: 0,
          marginTop: 2,
          border: `2px solid ${value ? "#1B4FD8" : "#CBD5E1"}`,
          background: value ? "#1B4FD8" : "#fff",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          transition: "all 0.15s ease",
...
export const Grid2 = ({ children }) => (
  <div className="responsive-grid-2" style={{ gap: "0 18px" }}>
    {children}
  </div>
);

export const Grid3 = ({ children }) => (
  <div className="responsive-grid-3" style={{ gap: "0 18px" }}>
    {children}
  </div>
);
